export default {
    ...
    config: {
        ...
        webdav: {
            title: "数据同步",
            description: "同步配置、亮暗主题、画布、我的资产、生成记录和本地媒体文件；可选择关闭、WebDAV 或本地文件夹。WebDAV 开启本地代理时经本机代理转发，否则浏览器直连。",
            ...
            off: "关闭",
            localFolder: "本地文件夹",
            localFolderUnsupported: "当前浏览器不支持本地文件夹同步，请使用 Chrome / Edge 桌面版",
            localFolderDescription: "请选择本地文件夹或已挂载的 NAS 共享目录。浏览器可能会在权限过期后要求重新授权。",
            chooseFolder: "选择同步文件夹",
            currentFolder: "当前：{{name}}",
            noFolder: "尚未选择",
            folderSelected: "同步文件夹已选择",
            folderSelectFailed: "选择同步文件夹失败",
            syncDisabled: "同步已关闭",
            missingFolder: "请先选择同步文件夹",
            connectionAvailable: "同步连接可用",
            connectionTestFailed: "同步连接测试失败",
            missingUrl: "请先填写 WebDAV 地址",
            available: "WebDAV 连接可用",
            testFailed: "WebDAV 连接测试失败",
            preparing: "准备同步",
            failed: "WebDAV 同步失败",
            completed: "同步完成：配置、{{projects}} 个画布，{{assets}} 个资产，{{records}} 条记录，本次上传 {{files}} 个文件 {{bytes}}",
            domains: {
                settings: "配置",
                canvas: "画布",
                assets: "我的资产",
