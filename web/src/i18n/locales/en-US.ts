export default {
    ...
    config: {
        ...
        webdav: {
            title: "Data sync",
            description: "Sync settings, light/dark theme, canvases, assets, generation history, and local media files using WebDAV or a local folder. AI API keys are excluded. WebDAV requests go through the local proxy when enabled; otherwise the browser connects directly.",
            ...
            localFolderUnsupported: "This browser does not support local-folder sync. Use desktop Chrome or Edge.",
            localFolderDescription: "Choose a local folder or mounted NAS share. The browser may request permission again after it expires.",
            chooseFolder: "Choose sync folder",
            currentFolder: "Current: {{name}}",
            noFolder: "Not selected",
            folderSelected: "Sync folder selected",
            folderSelectFailed: "Failed to choose a sync folder",
            syncDisabled: "Sync is disabled",
            missingFolder: "Choose a sync folder first",
            connectionAvailable: "Sync connection is available",
            connectionTestFailed: "Sync connection test failed",
            ...
            completed: "Sync complete: settings, {{projects}} canvases, {{assets}} assets, {{records}} records, and {{files}} files ({{bytes}}) uploaded",
            domains: {
                settings: "Settings",
                canvas: "Canvases",
                assets: "My Assets",
